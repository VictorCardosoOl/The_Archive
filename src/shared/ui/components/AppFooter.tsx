       ...
       <div className="w-full flex flex-col gap-2 md:gap-4 lg:gap-6">
          ...
          <div className="flex items-end justify-between w-full">
             ...
             <div className="flex items-center gap-4 md:gap-6 text-editorial-black pb-4 md:pb-6 lg:pb-10 pr-2">
                 <a 
                   ...
                   className="hover:text-editorial-gray hover:-translate-y-1 transition-all duration-300" 
                   aria-label="WhatsApp"
                 >
                 ...
                 <a 
                   href="https://www.instagram.com/hi.victorcdo/" 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   className="hover:text-editorial-gray hover:-translate-y-1 transition-all duration-300" 
                 ...
                 <a 
                   href="https://www.linkedin.com/in/victorccunha/" 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   className="hover:text-editorial-gray hover:-translate-y-1 transition-all duration-300" 
                   aria-label="LinkedIn"
                 ...
                 <a 
                   href="https://github.com/VictorCardosoOl" 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   className="hover:text-editorial-gray hover:-translate-y-1 transition-all duration-300" 
                   aria-label="GitHub"
          ...
          <div className="flex items-end justify-between w-full">
             ...
             <div className="flex flex-col items-end gap-1 text-right pb-4 md:pb-6 lg:pb-10 pr-2">
                <a 
                  href="https://victorcardoso.vercel.app/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="font-sans text-[8px] sm:text-[9px] uppercase tracking-[0.2em] text-editorial-gray hover:text-editorial-black transition-colors cursor-pointer"
                >
